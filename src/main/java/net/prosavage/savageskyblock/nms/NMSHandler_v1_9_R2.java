...
public class NMSHandler_v1_9_R2 extends NMSHandler {
   ...
   public void removeBlockSuperFast(int X, int Y, int Z, boolean applyPhysics) {
      net.minecraft.server.v1_9_R2.World w = ((org.bukkit.craftbukkit.v1_9_R2.CraftWorld) SavageSkyBlock.getSkyblock.getWorld()).getHandle();
      ...
      net.minecraft.server.v1_9_R2.IBlockData ibd = net.minecraft.server.v1_9_R2.Block.getByCombinedId(0);
